            ...
            <div style={{ background: '#fff', borderRadius: tokens.radius.xl, width: '640px', maxHeight: '90vh', overflowY: 'auto', padding: '40px' }}>
                <div ref={ref}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px', paddingBottom: '16px', borderBottom: '2px solid #0D9488' }}>
                        <div>
                            <div style={{ fontSize: '22px', fontWeight: '800', color: '#0D9488' }}>HRMate Pvt. Ltd.</div>
                    ...
                    {/* Net Pay */}
                    <div style={{ background: 'linear-gradient(135deg, #134E4A, #0F766E)', color: '#fff', borderRadius: '12px', padding: '16px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div style={{ fontSize: '14px', fontWeight: '700' }}>Net In-Hand Salary</div>
                        <div style={{ fontSize: '24px', fontWeight: '800' }}>{formatINR(s.netInHand)}</div>
                    </div>
                    <div style={{ marginTop: '16px', fontSize: '11px', color: '#94A3B8', textAlign: 'center' }}>
                        This is a computer-generated payslip and does not require a signature. · Generated by HRMate
                    </div>
                </div>
    ...
    return (
        <div className="animate-fade">
            ...
            {myEmployee?.ctcAnnual && (() => {
                ...
                return (
                    <div style={{ ...styles.card, marginBottom: '24px', background: 'linear-gradient(135deg, #0F172A 0%, #134E4A 100%)', border: 'none' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
                            <div>
                                <div style={{ fontSize: '12px', color: '#5EEAD4', fontWeight: '700', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '4px' }}>Current Package</div>
                                <div style={{ fontSize: '28px', fontWeight: '800', color: '#fff', letterSpacing: '-0.02em' }}>{formatINR(s.netInHand)} <span style={{ fontSize: '14px', fontWeight: '500', color: '#94A3B8' }}>/ month in-hand</span></div>
                                <div style={{ fontSize: '13px', color: '#94A3B8', marginTop: '4px' }}>CTC: {formatLPA(myEmployee.ctcAnnual)} · Gross: {formatINR(s.gross)}/mo</div>
                            </div>
                            <div style={{ display: 'flex', gap: '24px' }}>
                                {[
                                    ...
                                    <div key={item.l} style={{ textAlign: 'center' }}>
                                        <div style={{ fontSize: '10px', color: '#94A3B8', fontWeight: '700', textTransform: 'uppercase', marginBottom: '4px' }}>{item.l}</div>
                                        <div style={{ fontSize: '14px', fontWeight: '800', color: '#CCFBF1' }}>{item.v}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
